...
import (
	...
	"git.woa.com/bingo/bingo/runtime"
	"git.woa.com/bingo/bingo/runtime/plugin"
	"git.woa.com/bingo/bingo/util/log"
...
func (f *factory) Destory(i interface{}) error {
...
func (l *BingoLogger) asyncWriteLoop() error {
	...
	if err := runtime.SecureGO(loopFunc); err != nil {
		return fmt.Errorf("asyncWriteLoop err:%w", err)
	}
	return nil
}
