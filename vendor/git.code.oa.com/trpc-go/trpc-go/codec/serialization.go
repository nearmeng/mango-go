...
const (
	...
	SerializationTypeXML        = 5 // xml

	SerializationTypeUnsupported = 128 // 不支持
	SerializationTypeForm        = 129 // http application/x-www-form-urlencoded 表单kv结构
	SerializationTypeGet         = 130 // http server 处理get请求
	SerializationTypeFormData    = 131 // http multipart/form-data kv 请求处理
)
