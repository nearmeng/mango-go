...
func ReportSingleDimensionMetrics(name string, value float64, policy Policy, opts ...Option) error {
	...
	return Report(r, opts...)
}

// NewMultiDimensionMetrics 创建一个多维上报记录
// Deprecated 请使用NewMultiDimensionMetricsX
...
// NewMultiDimensionMetricsX 创建一个多维上报记录
...
// Deprecated 请使用ReportMultiDimensionMetricsX
func ReportMultiDimensionMetrics(dimensions []*Dimension, metrics []*Metrics, opts ...Option) error {
	return ReportMultiDimensionMetricsX("", dimensions, metrics, opts...)
}

// ReportMultiDimensionMetricsX 创建一个多维上报记录，并上报
